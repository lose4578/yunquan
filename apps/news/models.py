...
class News(models.Model):
    ...
    news_id = models.IntegerField(verbose_name=u'新闻id', default=int(nowtime))
    ...
    news_img = models.ImageField(verbose_name="新闻封面", null=True, upload_to='image/%Y/%m', default=u'image/default.png',
                                 max_length=100)
